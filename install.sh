...
APP="$APPNAME xfce4-terminal xfce4-power-manager volumeicon xscreensaver conky tint2 xbindkeys firefox notify-send iwconfig catfish dmenu "
PERL=""
PYTH=""
PIPS=""
CPAN=""
...
# Other dependencies
dotfilesreq git htop misc jgmenu polybar gtk-2.0 gtk-3.0 sxhkd volumeicon rofi
dotfilesreqadmin
